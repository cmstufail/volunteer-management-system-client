...
const AddPost = () => {
  ...
  return (
    <Container>
      <div className="bg-base-200 dark:bg-gray-800 py-12 md:px-3 xl:px-2">
        <div className="p-8 shadow-xl rounded-lg my-16">
          ...
          <form onSubmit={ handleSubmit } className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="form-control">
                <label className={ `mt-2 ${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">Thumbnail URL</span></label>
                <input type="text" name="thumbnail" placeholder="Enter image URL" required className="input input-bordered w-full" />
              </div>
              <div className="form-control">
                <label className={ `mt-2 ${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">Post Title</span></label>
                <input type="text" name="postTitle" placeholder="Enter post title" required className="input input-bordered w-full" />
              </div>
            </div>

            <div className="form-control">
              <label className={ ` ${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">Description</span></label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="form-control">
                <label className={ ` ${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">Category</span></label>
              ...
              <div className="form-control">
                <label className={ `${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">Location</span></label>
                <input type="text" name="location" placeholder="e.g., Dhaka, Bangladesh" required className="input input-bordered w-full" />
              </div>
              <div className="form-control">
                <label className={ `${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">No. of Volunteers Needed</span></label>
            ...
            <div className="form-control space-x-2">
              <label className={ `${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">Deadline</span></label>
              <DatePicker
                selected={ deadline }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t dark:border-gray-700">
              <div className="form-control">
                <label className={ ` ${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">Organizer Name</span></label>
              ...
              <div className="form-control">
                <label className={ ` ${ isDark ? 'text-gray-300' : 'text-gray-600' } label` }><span className="label-text">Organizer Email</span></label>
            ...
            <div className="form-control mt-8 flex justify-center">
              <button type="submit" className="btn btn-outline btn-lg w-full" disabled={ isLoading }>
